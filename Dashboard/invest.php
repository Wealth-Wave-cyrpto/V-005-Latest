...
<div class="sales-analytics">
  ...
  <div class="context-el">
      ...
      <div class="context-menu">
                <form action="">
                    <p id="title-el">Select Coin</p>
                        <div class="btns">
                            <input type="button" value="Bitcoin" class="bit-el">
                            <input type="button" value="USDT" class="eth-el">
                            <input type="button" value="LiteCoin" class="lt-el">
                        </div>
                </form>        
        </div>

        <!-- QR section -->
        <div class="context-menu qr-sec">  
              <div class="qr-el">
                    <img src="" id="qr-img"  alt="Qr code">
                      
                      <div class="copy">
                        <input type="text" class="text" id="qr-txt" value="">
                        <input type="button" value="copy" class="copy-btn">
                      </div>
              </div>     
        </div>
        <!-- End of QR section -->
...
<!--End of Tawk.to Script-->
       ...
       <script src="Assets/Javascript/invest.js"></script> 
    </body>
</html>
